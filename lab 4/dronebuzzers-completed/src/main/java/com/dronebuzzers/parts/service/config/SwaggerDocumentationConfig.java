package com.dronebuzzers.parts.service.config;
...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("")
            .version("1.0.0")
            .contact(new Contact("","", "luc.gorissen@amis.nl"))
            .build();
    }
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.dronebuzzers.parts.service.api"))
                    .build()
